            ...
            <div class="Container">
                <div id="car3" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item ">
                            <img src="images/carousel-11.jpeg" class="img-fluid">
                        </div>
                        <div class="carousel-item ">
            ...
            <div class="row1">
                <div class="col-1-of-4 u-margin-top-large">
                    <div style="overflow-y: auto;" class="sidetext__box">
                        ...
                        • Thal Sainik Camp (TSC)<br>
                        • Vayu Sainik Camp (VSC)<br>
                        • Nau Sainik Camps (NSC)<br>
                        • Rock Climbing Camp<br>
                        • National Integration Camps (NIC)<br>
                        • RDC and PM‘s Rally<br>
                ...
                <div class="row1">
                        ...
                        <div class="footer__address">
                            <ul>
                                ...
                                <li class="footer__item"><i class="fa fa-envelope footer__icons footer__icons--mid"></i>
                                    <p align="justify" class="footer__para">ncc@gndec.ac.in</p>
                                </li>
                            <li class="footer__item"><i class="fa fa-envelope footer__icons footer__icons--mid"></i>
                                <p align="justify" class="footer__para">nccgndecofficial@gmail.com</p>
                            </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-1-of-3">
                        <div class="footer__copyright">
                            <p class="u-margin-bottom-very-small"><a href="https://indiancc.nic.in/" id="developer_id">DGNCC
                                </a>
                            </p>
